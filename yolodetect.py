...
class YoloDetect():
    def __init__(self, detect_class="x", frame_width=1510, frame_height=463):
        # Parameters
        self.classnames_file = "model/classnames.txt"
        self.weights_file = "model/yolov4-custom_last.weights"
        self.config_file = "model/yolov4-custom.cfg"
