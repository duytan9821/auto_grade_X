...
class Detector:
    ...
    def __init__(self, config_path='./yolov4-custom.cfg', weights_path='./yolov4-custom_last.weights',
                 coco_names_path='./yolo.names', score_threshold=0.5, NMS_threshold=0.5):
        """
